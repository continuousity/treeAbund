...
The sojourn time in generations of $k$ lineages coalescing to $k - 1$ lineages is $\tau \sim exp\left\{\binom{k}{2}\right\}$. So we can simulate the coalescent this way
